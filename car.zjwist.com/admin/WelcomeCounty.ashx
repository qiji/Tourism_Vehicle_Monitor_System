...
public class WelcomeCounty : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //    wsd.ChartEnterCount.Add(Convert.ToInt32(dr["EnterCount"]));
        //    wsd.ChartLeaveCount.Add(Convert.ToInt32(dr["LeaveCount"]));
        //}
        ...
        foreach (DataRow dr in ds.Tables[6].Rows)
        {
            ...
            wsd.MapData += "\"" + dr["City"].ToString() + "\":[" + dr["lon"].ToString() + "," + dr["lat"].ToString() + "],";
        }
